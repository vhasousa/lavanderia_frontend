...
import styles from './ClientServicesTable.module.css'
...
const ClientServicesTable: React.FC<ClientServicesTableProps> = ({ updateTrigger, searchTerm, statusFilter }) => {
        ...
        <tbody>
          {services.length > 0 ? (
            services.map((service) => (
              <tr key={service.id} onClick={() => openModal(service.id)}>
